...
<body onload="slideDocs('airtime-docs');">
    ...
    <div class="card info-card px-5 py-5">
        <div class="container">
            <div class="col-12">
                ...
                <form method="post" action="" class="">
                    <input style="user-select: auto; text-align: center;" name="" type="text" value="<?php echo $get_logged_user_details["api_key"]; ?>" placeholder="API Key" class="form-control mb-1" readonly/>
                    <button style="user-select: auto;" name="regenerate" type="submit" class="btn btn-primary col-12" >
                        Regenerate Key
                    </button>
                </form>
            </div>
		...
		<div class="d-block justify-items-center justify-content-between mt-2">
  		...
  		<button style="user-select: auto;" onclick="slideDocs('requery-docs');" class="btn btn-primary col-auto mb-1">
  			<a href="#requery-docs" style="text-decoration: none;" class="text-white">
  		    REQUERY TRANSACTION
  		   </a>
  		</button>
  
  		<button style="user-select: auto;" onclick="slideDocs('status-code-docs');" class="btn btn-primary col-auto mb-1">
		...
		<div id="airtime-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
				...
				<span style="user-select: auto;" class="h6">This section contains all the step to integrate our RESTful API</span><br/>
				...
				<input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/airtime.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
				...
				<span style="user-select: auto; line-height: 20px;" class="h6">
					...
					* network: <span class="fw-bold">This is the service you are paying for e.g mtn et.c network code(Product Code) is on the table below</span><br/>
				...
				<span style="user-select: auto;" class="h6">On a successful airtime transaction, you get a json response e.g:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h6">
      ...
      <table style="" class="table table-responsive table-striped table-bordered" title="Horizontal Scroll: Shift + Mouse Scroll Button">
		...
		<div id="data-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
				...
				<span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
				<input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/data.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
				<span style="user-select: auto;" class="h6">Required Parameters:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h6">
					* api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
					* network: <span class="fw-bold">This is the service you are paying for e.g mtn et.c network code(Product Code) is on the table below</span><br/>
					* phone_number: <span class="fw-bold">This is the recipient phone number</span><br/>
					* type: <span class="fw-bold">This is the type of data e.g sme-data, cg-data, dd-data</span><br/>
				...
				<span style="user-select: auto;" class="h6">On a successful data transaction, you get a json response e.g:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h6">
    ...
    <table style="" class="table table-responsive table-striped table-bordered" title="Horizontal Scroll: Shift + Mouse Scroll Button">
		...
		<div id="cable-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
				...
				<span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
				<input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/cable.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
				<span style="user-select: auto;" class="fw-bold h5">Required Parameters:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h6">
					* api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
					* type: <span class="fw-bold">This is the service you are paying for e.g startimes et.c Type is on the table below</span><br/>
					* iuc_number: <span class="fw-bold">This is the recipient IUC number</span><br/>
					* package: <span class="fw-bold">This is the selected cable package to subscribe e.g nova, jolli, padi et.c</span><br/>
				</span><br/>
				<span style="user-select: auto;" class="fw-bold h5">API Response</span><br/>
				<span style="user-select: auto;" class="h6">On a successful cable transaction, you get a json response e.g:</span><br/>
				...
				<span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
				<input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/verify-cable.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
				<span style="user-select: auto;" class="fw-bold h5">Required Parameters:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
					* api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
					* type: <span class="fw-bold">This is the service you are paying for e.g startimes et.c Type is on the table below</span><br/>
      ...
      <table style="" class="table table-responsive table-striped table-bordered" title="Horizontal Scroll: Shift + Mouse Scroll Button">
		...
		<div id="exam-pin-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
				...
				<span style="user-select: auto;" class="h5">This section contains all the step to integrate our RESTful API</span><br/>
				<span style="user-select: auto;" class="fw-bold h5">EXAM BASE URL</span><br/>
				<span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
				<input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/exam.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
				<span style="user-select: auto;" class="fw-bold h5">Required Parameters:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
					* api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
					* type: <span class="fw-bold">This is the service you are paying for e.g waec et.c Type is on the table below</span><br/>
					* quantity: <span class="fw-bold">This is the quantity. Qty in the table</span>
				</span><br/>
				<span style="user-select: auto;" class="fw-bold h5">API Response</span><br/>
				<span style="user-select: auto;" class="h6">On a successful exam transaction, you get a json response e.g:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
      ...
      <table style="" class="table table-responsive table-striped table-bordered" title="Horizontal Scroll: Shift + Mouse Scroll Button">
		...
		<div id="electric-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
				...
				<span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
				<input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/electric.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
				<span style="user-select: auto;" class="fw-bold h5">Required Parameters:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
					* api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
					* type: <span class="fw-bold">This is the service you are paying for e.g prepaid or postpaid et.c</span><br/>
					* meter_number: <span class="fw-bold">This is the recipient Meter number</span><br/>
					* provider: <span class="fw-bold">This is the selected cable package to subscribe e.g ikedc, jedc, ibedc et.c</span><br/>
					* amount: <span class="fw-bold">This is the amount of electricity unit to purchase</span>
				</span><br/>
				<span style="user-select: auto;" class="fw-bold h5">API Response</span><br/>
				<span style="user-select: auto;" class="h6">On a successful electric transaction, you get a json response e.g:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
				...
				<span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
				<input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/verify-electric.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
				<span style="user-select: auto;" class="fw-bold h5">Required Parameters:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
					* api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
					* type: <span class="fw-bold">This is the service you are paying for e.g prepaid or postpaid et.c</span><br/>
				...
				<span style="user-select: auto;" class="fw-bold h5">API Response</span><br/>
				<span style="user-select: auto;" class="h6">On a successful electric verification, you get a json response e.g:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
					{"status": "success", "desc":"Abdulrahaman Habeebullahi"}
				</span>
			</div>
      ...
      <table style="" class="table table-responsive table-striped table-bordered" title="Horizontal Scroll: Shift + Mouse Scroll Button">
        ...
        <div id="card-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
                ...
                <span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
                <input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/card.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
                <span style="user-select: auto;" class="fw-bold h5">Required Parameters:</span><br/>
                <span style="user-select: auto; line-height: 20px;" class="h5">
                    * api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
                    * network: <span class="fw-bold">This is the service you are paying for e.g mtn et.c network code(Product Code) is on the table below</span><br/>
                    ...
                    * quantity: <span class="fw-bold">This is the card size e.g 1gb, 2gb, 100, 200  e.t.c</span><br/>
                    * card_name: <span class="fw-bold">This is the business name on card (Optional) e.g BeeTech Solution</span>
                </span><br/>
                <span style="user-select: auto;" class="fw-bold h5">API Response</span><br/>
                <span style="user-select: auto;" class="h6">On a successful data transaction, you get a json response e.g:</span><br/>
                <span style="user-select: auto; line-height: 20px;" class="h5">
		...
		<div id="bulk-sms-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
                ...
                <span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
                <input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/sms.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
                <span style="user-select: auto;" class="fw-bold h5">STANDARD SMS & FLASH SMS:</span><br/>
                <span style="user-select: auto;" class="fw-bold h5">Required Parameters:</span><br/>
                <span style="user-select: auto; line-height: 20px;" class="h5">
                    * api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
                    * network: <span class="fw-bold">This is the service you are paying for e.g mtn et.c network code(Product Code) is on the table below</span><br/>
                    * phone_number: <span class="fw-bold">This is the recipient phone numbers (comma seperated) e.g 09024089614, 08124232128</span><br/>
					...
					* date: <span class="fw-bold">This is the scheldule date e.g YYYY-MM-DD HH:MM:SS (optional)</span>
                </span><br/>
                <span style="user-select: auto;" class="fw-bold h5">API Response</span><br/>
                <span style="user-select: auto;" class="h6">On a successful bulk-sms transaction, you get a json response e.g:</span><br/>
                <span style="user-select: auto; line-height: 20px;" class="h5">
                ...
                <span style="user-select: auto; line-height: 20px;" class="h5">
                    * api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
                    * network: <span class="fw-bold">This is the service you are paying for e.g mtn et.c network code(Product Code) is on the table below</span><br/>
                    * phone_number: <span class="fw-bold">This is the recipient phone number e.g 09024089614</span><br/>
                    * otp_type: <span class="fw-bold">This is the type of PIN code that will be generated and sent as part of the OTP message. You can set OTP type to <b>numeric</b> or <b>alphanumeric</b></span><br/>
                    * type: <span class="fw-bold">This is the type of sms e.g otp</span><br/>
                    * pin_attempts: <span class="fw-bold">This is the number of times the PIN can be attempted before expiration. It has a minimum of one attempt</span><br/>
                    * expires: <span class="fw-bold">This represents how long the PIN is valid before expiration. The time is in minutes. The minimum time value is 0 and the maximum time value is 60</span><br/>
					* pin_length: <span class="fw-bold">This is the length of the PIN code. It has a minimum of 4 and maximum of 8.</span>
                </span><br/>
                <span style="user-select: auto;" class="fw-bold h5">API Response</span><br/>
                <span style="user-select: auto;" class="h6">On a successful bulk-sms transaction, you get a json response e.g:</span><br/>
                <span style="user-select: auto; line-height: 20px;" class="h5">
		...
		<div id="requery-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
				...
				<span style="user-select: auto;" class="h6">Make HTTP POST request to this endpoint</span><br/>
				<input style="user-select: auto; text-align: left;" type="text" value="<?php echo $web_http_host."/web/api/requery.php"; ?>" placeholder="API Key" class="form-control mb-1" readonly/><br/>
				<span style="user-select: auto;" class="fw-bold h5">Required Parameters:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
					* api_key: <span class="fw-bold">This is the generated API KEY on your user account</span><br/>
		...
		<div id="status-code-docs" class="api_docs_div card px-5 py-5">
			<div style="user-select: auto;" class="col-12 lh-lg">
				...
				<span style="user-select: auto;" class="fw-bold h5">API Response</span><br/>
				<span style="user-select: auto;" class="h6">On a successful transaction, you get a json response e.g:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
					{"ref":873387339873, "status": "success", "desc":"Transaction Successful"}
				</span><br/>
				<span style="user-select: auto;" class="h6">On a pending transaction, you get a json response e.g:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
					{"ref":873387339873, "status": "pending", "desc":"Transaction Pending"}
				</span><br/>
				<span style="user-select: auto;" class="h6">On a failed transaction, you get a json response e.g:</span><br/>
				<span style="user-select: auto; line-height: 20px;" class="h5">
