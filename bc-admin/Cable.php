<?php session_start();
    ...
    if(isset($_POST["install-product"])){
        ...
        $array_startimes_product_variety = array("nova_weekly", "basic_weekly", "smart_weekly", "classic_weekly", "super_weekly", "nova", "basic", "smart", "classic", "super", "chinese_dish", "nova_antenna", "special_weekly", "special_monthly", "nova_dish_weekly", "super_antenna_weekly", "super_antenna_monthly", "combo_smart_basic_weekly", "combo_special_basic_weekly", "combo_super_classic_weekly", "combo_smart_basic_monthly", "combo_special_basic_monthly", "combo_super_classic_monthly");
        $array_dstv_product_variety = array("padi","yanga","confam","compact","premium","asia","padi_extraview","yanga_extraview","confam_extraview","compact_extra_view","compact_plus","compact_asia_extraview","compact_plus_extra_view","compact_plus_frenchplus_extra_view","compact_plus_asia_extraview","premium_extra_view","premium_asia_extra_view","premium_french_extra_view");
