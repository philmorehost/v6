<?php session_start();
    ...
    if(isset($_POST["install-product"])){
        ...
        $array_mtn_product_variety = array("250mb","500mb","1gb","2gb","3gb","5gb","10gb");
        $array_airtel_product_variety = array("300mb","500mb","1gb","2gb","5gb","10gb");
        $array_glo_product_variety = array("200mb", "500mb", "1gb", "2gb", "3gb", "5gb", "10gb");
