<?php session_start();
    ...
    if(isset($_POST["install-product"])){
        ...
        $array_airtel_product_variety = array("1gb","1.5gb","5gb","20gb","40gb");
        $array_glo_product_variety = array("1gb_awoof_data","2gb_awoof_data","3.5gb_awoof_data","15gb_awoof_data");
