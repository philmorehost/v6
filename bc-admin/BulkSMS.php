<?php session_start();
    ...
    if(isset($_POST["install-product"])){
        ...
        $array_mtn_product_variety = array("standard_sms", "flash_sms", "in_app_otp");
        $array_airtel_product_variety = array("standard_sms", "flash_sms", "in_app_otp");
        $array_glo_product_variety = array("standard_sms", "flash_sms", "in_app_otp");
        $array_9mobile_product_variety = array("standard_sms", "flash_sms", "in_app_otp");
