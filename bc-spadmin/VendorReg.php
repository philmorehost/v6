    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">VendorReg</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="card info-card px-5 py-5">
          <div class="row mb-3">
            <form method="post" enctype="multipart/form-data" action="">
              ...
              <div style="text-align: center;" class="container">
                  <span id="user-status-span" class="h5 fw-bold text-dark" style="user-select: auto;">WEBSITE URL</span>
              </div><br/>
              ...
              <div style="text-align: center;" class="container">
                  <span id="user-status-span" class="h5 fw-bold text-dark" style="user-select: auto;">VENDOR BANK INFORMATION</span>
              </div><br/>
              ...
              <input style="text-align: center;" name="account-number" type="text" value="" placeholder="Account Number (optional)" pattern="[0-9]{10}" title="Account number must be 10 digit long" class="form-control mb-1" /><br/>
              
              <div style="text-align: center;" class="container">
              	<span id="user-status-span" class="h5 fw-bold text-dark" style="user-select: auto;">VENDOR VERIFICATION</span>
              </div><br/>
              <input style="text-align: center;" name="bvn" type="text" value="" placeholder="BVN (optional)" pattern="[0-9]{11}" title="BVN must be 11 digit long" class="form-control mb-1" /><br/>
              <input style="text-align: center;" name="nin" type="text" value="" placeholder="NIN (optional)" pattern="[0-9]{11}" title="NIN must be 11 digit long" class="form-control mb-1" /><br/>
              
              <div style="text-align: center;" class="container">
                  <span id="user-status-span" class="h5 fw-bold text-dark" style="user-select: auto;">PASSWORD</span>
              </div><br/>
